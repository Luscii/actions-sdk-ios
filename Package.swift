...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Actions",
            url: "https://github.com/Luscii/actions-sdk-ios/releases/download/1.1.0/Actions.xcframework.zip",
            checksum: "c303149b7e0705ff7da1e48acaaf1e2c8b6069246ae3c350dbe4483a40cdd239"
        ),
        .target(
            name: "Rx",
            dependencies: [
