...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Actions",
            url: "https://github.com/Luscii/actions-sdk-ios/releases/download/0.2.4/Actions.xcframework.zip",
            checksum: "55bc01bda8817982d1b0bada82947f82464e3ff78f037e0cfeecde563ae7d7c9"
        ),
        .target(
            name: "Rx",
            dependencies: [
